...
export function InteractiveHoverButton(props: LinkProps | ButtonProps) {
  ...
  const content = (
    <>
      ...
      {/* Fond vert animé */}
      <span className="absolute left-[7%] top-[40%] z-0 h-2 w-2 scale-[1] rounded-lg bg-green-600 transition-all duration-300 group-hover:left-[0%] group-hover:top-[0%] group-hover:h-full group-hover:w-full group-hover:scale-[1.8]" />
    </>
  );
